                  ...
                  <?php echo validation_errors(); ?>
                   ...
                   if($success_msg){ 
                    ...
                    ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('user/basic'); ?>">
                              ...
                              <button name="register" class="btn btn-lg btn-success btn-block" type="submit" >Registered</button>
