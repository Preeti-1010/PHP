          ...
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <div class="container-fluid">
                <div class = "card-header bg-white border-0">EDIT QUESTION</div><br>
                <form id="addques" class="form" method="post" action="<?= base_url('/admin/editquestion');?>">
                  <?php 
                ...
                ?>
                  <div class="pl-lg-12">
                    ...
                    <?php foreach ($edit_question as $q) {?>
                    <div class="row" style="display: block;">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label>Question :</label>
                          <textarea style="height: 10em;" class="form-control form-control-alternative" value="<?php echo $q->question_id; ?>"  name="ques" id="ques"><?php echo $q->question; ?></textarea>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label></label>
                          <button type="submit" class="btn btn-sm btn-primary" name="editquesbtn" value="EDIT">EDIT</button> 
                        </div>
                      </div>
                    </div>
                  </div>
