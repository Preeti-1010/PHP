...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo base_url(); ?>/admin">Dashboard</a>
        <!-- Form -->
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="<?php echo base_url(); ?>admin-assets/img/theme/team-4-800x800.jpg">
                </span>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Competition</h5>
  ...
  <!-- admin Scripts -->
  <!-- Core -->
  <script src="<?php echo base_url(); ?>admin-assets/vendor/jquery/dist/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>admin-assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <!-- Optional JS -->
  <script src="<?php echo base_url(); ?>admin-assets/vendor/chart.js/dist/Chart.min.js"></script>
  <script src="<?php echo base_url(); ?>admin-assets/vendor/chart.js/dist/Chart.extension.js"></script>
  <!-- admin JS -->
  <script src="<?php echo base_url(); ?>admin-assets/js/argon.js?v=1.0.0"></script>
</body>
